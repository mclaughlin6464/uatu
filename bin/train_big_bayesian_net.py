...
#device = '/cpu:0'
print time() - t0
train(bayesian_convnet_init_fn, standard_optimizer_init_fn, original_bayes_cost_fn, data, device, num_epochs = 100, fname = '/home/users/swmclau2/scratch/UatuCheckpoints/bayes_big', print_every = 500)#, lr = 0.00005) 
