...
bins = np.loadtxt('/home/users/swmclau2/scratch/uatu_bins.npy')[3:]
...
chain_fname = '/home/users/swmclau2/scratch/simulated_chain5_%02d_walkers_%02d_steps.npy'%(nwalkers, nsteps)

with open(chain_fname, 'w') as f:
    f.write('#' + '\t'.join(['Om', 's8', 'log_sOm', 'log_ss8', 'rho'])+'\n')

for pos in simulate_analysis_iterator(obsboxdir, bins, invcov, nwalkers, nsteps, ncores=8):
