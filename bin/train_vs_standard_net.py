...
#device = '/cpu:0'
print time() - t0
train(very_shallow_convnet_init_fn, standard_optimizer_init_fn, standard_cost_fn, data, device, num_epochs = 100, fname = '/home/users/swmclau2/scratch/UatuCheckpoints/vs_standard_net2', print_every = 500)#, lr = 0.001) 
