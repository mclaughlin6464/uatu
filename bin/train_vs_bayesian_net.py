...
#device = '/cpu:0'
print time() - t0
train(very_shallow_bayesian_convnet_init_fn, standard_optimizer_init_fn, bayes_cost_fn, data, device, num_epochs = 100, fname = '/home/users/swmclau2/scratch/UatuCheckpoints/bayes_vs_shallow2', print_every = 500)#, lr = 0.00005) 
