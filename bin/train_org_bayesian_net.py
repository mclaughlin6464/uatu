...
#device = '/cpu:0'
print time() - t0
train(shallow_original_bayesian_convnet_init_fn, standard_optimizer_init_fn, original_bayes_cost_fn, data, device, num_epochs = 100, fname = '/home/users/swmclau2/scratch/bayes_org_shallow2', print_every = 500)#, lr = 0.00005) 
