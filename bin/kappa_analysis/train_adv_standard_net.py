...
#dropout 0.2
# standard cost
train(gupta_adv_network_large_filters_init_fn, standard_optimizer_init_fn, adversarial_standard_abs_cost_fn, data, num_epochs = 50, fname = '/scratch/users/swmclau2/uatu_networks/gupta_net_kappa_adv_abs_large_filters', print_every = 500, lr_np = 2e-4, lam_np = 0.0, adv = True)
