...
#dropout 0.2
# standard cost
train(gupta_network_init_fn, standard_optimizer_init_fn, adversarial_standard_abs_cost_fn, data, num_epochs = 50, fname = '/scratch/users/swmclau2/uatu_networks/gupta_net_kappa_adv_abs', print_every = 1000, lr_np = 2e-4, lam_np = 0.0, adv = True)
