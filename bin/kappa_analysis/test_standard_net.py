...
fname = path.join(dir, 'UatuLightconeAttacked.hdf5')
...
test(gupta_network_init_fn, test_dset, n_samples = 1 ,\
        fname = '/home/users/swmclau2/scratch/gupta_net_kappa-28900', samples_fname = path.join(dir, 'UatuLightconePredsAttacked.hdf5')) 
