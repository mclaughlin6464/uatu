...
device = "/device:GPU:0"
#device = '/cpu:0'
test(shallow_original_bayesian_convnet_init_fn, data, 10, device,'/home/users/swmclau2/scratch/bayes_org_shallow2-1000', '/home/users/swmclau2/scratch/org_bayesian_net_preds_training') 
