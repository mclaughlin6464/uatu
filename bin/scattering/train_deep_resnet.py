...
init_epoch = 0
if init_epoch>0:
    model_path = path.join(output_dir, 'deep_resnet_reg_smooth_%0.1f_noise_%0.1f_%02d_v8.pth'%(smooth, noise,init_epoch))
...
for epoch in range(init_epoch, epochs):
    ...
    if epoch%1==0:
        torch.save(model.state_dict(), path.join(output_dir, 'deep_resnet_reg_smooth_%0.1f_noise_%0.1f_%02d_v8.pth'%(smooth, noise,epoch)))
