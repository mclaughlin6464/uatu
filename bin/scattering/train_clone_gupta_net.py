...
clone_fname = path.join(dir, 'UatuLightconeTrainingGuptaRobustified.hdf5')
...
#        lr = 5e-7
    ...
    if epoch%1==0:
        torch.save(model.state_dict(), path.join(output_dir, 'gupta_net_clone_epoch_%02d.pth'%(epoch)))
