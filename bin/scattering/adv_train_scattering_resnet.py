...
train_dset = DatasetFromFile(fname,batch_size, shuffle=True, augment=True, train_test_split = 0.2, whiten = True, cache_size = 50, transform=torch.Tensor)
...
for epoch in range(epochs):
    ...
    adv_train(model, device, train_dset, optimizer, epoch+1, scattering, print_every=100)
