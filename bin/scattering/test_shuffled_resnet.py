...
output_fname = path.join(output_dir, 'deep_resnet_shuffle2_reg_smooth_%0.1f_noise_%0.1f_%02d.hdf5'%(smooth, noise,epoch))
...
model_path = '/home/users/swmclau2/scratch/uatu_networks/deep_resnet_shuffle2_reg_smooth_%0.1f_noise_%0.1f_%02d.pth'%(smooth, noise,epoch)
