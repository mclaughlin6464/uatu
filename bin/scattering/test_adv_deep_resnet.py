...
if smooth==0:
    ...
    orig_fname = path.join(dir, 'UatuFastPMTest_smooth_1.0_noise_0.3.hdf5')
...
data_mod = lambda x: x #gaussian_filter(x+np.random.randn(*x.shape)*shape_noise, smooth)
...
output_fname = path.join(output_dir, 'adv_deep_resnet_reg_smooth_%0.1f_noise_%0.1f_%02d_v8.hdf5'%(smooth, noise,epoch))
...
model_path = '/home/users/swmclau2/scratch/uatu_networks/deep_resnet_reg_smooth_%0.1f_noise_%0.1f_%02d_adv_v8.pth'%(smooth, noise,epoch)
