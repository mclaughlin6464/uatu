...
clone_fname  = path.join(dir2, 'UatuFastPMTrainingRobustifyDeepResnetRegAdvWhiteNoise%0.1f_v6.hdf5'%smooth)
...
init_epoch = 0
output_fname = 'deep_resnet_reg_smooth_%0.1f_noise_%0.1f_%02d_white_clone_v6.pth'
if init_epoch>0:
