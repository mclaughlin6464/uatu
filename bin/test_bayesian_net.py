...
device = "/device:GPU:0"
#device = '/cpu:0'
test(shallow_bayesian_convnet_init_fn, data, 10, device,'/home/users/swmclau2/scratch/UatuCheckpoints/bayes_shallow2-1000', '/home/users/swmclau2/scratch/bayesian_net_preds2') 
